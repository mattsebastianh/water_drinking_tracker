...
2. **Set your daily goal**
   - Use the **Daily Goal** buttons (1500–3000ml) to choose your target.
3. **Log your drinks**
   - Use the **Quick Add** buttons, or type a custom value (ml) and press **+ Add** / Enter.
4. **Review / edit today’s log**
   - Check **Today’s Log** and use ✕ to remove an entry if needed.
5. **Reset the day**
   - Click **Reset Day** to clear today’s totals.
